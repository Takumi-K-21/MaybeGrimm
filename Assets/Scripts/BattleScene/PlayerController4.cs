...
public class PlayerController4 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (interval >= 0.5f)
        {
            ...
            if (Input.GetKey(KeyCode.LeftControl))
            {
                ...
                PlayerBullet4 bulletScript = bullet.GetComponent<PlayerBullet4>();
        ...
        if (Input.GetKey(KeyCode.LeftShift) && isCharge)
        {
            ...
            ChargeShot4 bulletScript = cBullet.GetComponent<ChargeShot4>();
            bulletScript.setVelocity(v_x * direction_x, v_y * direction_y, v_z * direction_z);
    ...
    void OnCollisionEnter(Collision other) {
        ...
        if (other.gameObject.tag == "Exp") {
            bool flag = LevelSystem4.EndBattle();
            SetImage.isGet = true;
        }
